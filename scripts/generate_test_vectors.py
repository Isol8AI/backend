...
from core.crypto.primitives import derive_key_from_ecdh  # noqa: E402
from tests.utils.crypto_test_utils import derive_key_from_passcode  # noqa: E402
...
def generate_vectors():
    ...
    frontend_output = (
        Path(__file__).parent.parent.parent / "frontend" / "tests" / "fixtures" / "crypto_test_vectors.json"
    )
